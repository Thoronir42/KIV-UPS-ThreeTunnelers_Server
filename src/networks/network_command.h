...
#define NCT_CLIENT_INTRODUCE 10
#define NCT_CLIENT_DISCONNECT 11
#define NCT_CLIENT_FETCH_GAME_LIST 14
#define NCT_CLIENT_GAME_ROOM_LIST 15    
#define NCT_CLIENT_CREATE_GAME 16
#define NCT_CLIENT_JOIN_GAME 17
#define NCT_CLIENT_LEAVE_GAME 18
