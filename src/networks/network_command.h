...
#define NCT_LEAD_STILL_THERE 3
#define NCT_LEAD_BAD_FORMAT 4
#define NCT_LEAD_INTRODUCE 5
#define NCT_LEAD_REINTRODUCE 6

#define NCT_CONNECTION_FETCH_GAME_LIST 10
#define NCT_CONNECTION_CREATE_GAME 11
#define NCT_CONNECTION_JOIN_GAME 12
#define NCT_CONNECTION_RECONNECT 13
#define NCT_CONNECTION_DISCONNECT 20
#define NCT_CONNECTION_GAME_ROOM_LIST 25
#define NCT_CONNECTION_GAME_ROOM_LIST_END 26

#define NCT_MSG_PLAIN 40
#define NCT_MSG_RCON 45

#define NCT_ROOM_WRONG_PHASE 110
#define NCT_ROOM_PLAYER_WHO_IS 111
#define NCT_ROOM_PLAYER_INTRODUCE 112
#define NCT_ROOM_SET_COLOR 113
#define NCT_ROOM_KICK_PLAYER 118
#define NCT_ROOM_PLAYER_LEFT 119
